...
function init_zone_script(zone)
    ...
    SetLocationProximityFunction(Zone,-753.87, -3.03, 592.89, 60, "ArcherWoods","LeaveLocation")
    ...
    SetLocationProximityFunction(Zone,424.28, -43.66, 733.90, 40, "ClodwindPoint","LeaveLocation")
    ...
    SetLocationProximityFunction(Zone,361.84, -19.69, -664.18, 12, "TombofVarsoon","LeaveLocation")
    ...
    SetLocationProximityFunction(Zone,-376.53, -0.70, -369.36, 35, "ArdentHills","LeaveLocation")
    ...
    SetLocationProximityFunction(Zone,-1410.68, -13.88, -742.63, 50, "RuinsofCaltorsis","LeaveLocation")
    SetLocationProximityFunction(Zone,-1865, -38, -550, 50, "WindstalkerVillage","LeaveLocation")
    SetLocationProximityFunction(Zone,-2182.37, -11.79, -818.23, 50, "WindstalkerHighlands","LeaveLocation")
    SetLocationProximityFunction(Zone,-2262.04, -24.72, -570.99, 50, "CoastalGrove","LeaveLocation")
    SetLocationProximityFunction(Zone,-2048.99, 15.74, -483.06, 18, "FangbreakerKeep","LeaveLocation")
    SetLocationProximityFunction(Zone,-1851.41, -22.03, -194.27, 55, "NorthernFarmlands","LeaveLocation")
    SetLocationProximityFunction(Zone,-2104, -43, 438, 18, "KeepoftheGnollSlayer","LeaveLocation")
    SetLocationProximityFunction(Zone,-1755, -14, 521, 50, "GnollslayerHighlands","LeaveLocation")
    SetLocationProximityFunction(Zone,-1973.00, -20.08, 640.00, 40, "ScarecrowFields","LeaveLocation")
    SetLocationProximityFunction(Zone,-2082.70, 47.26, 1029.12, 50, "HiddenVale","LeaveLocation")
