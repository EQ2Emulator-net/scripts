...
--]]
function Init(Quest)
	AddQuestStepKill(Quest, 1, "Kill Diseased Ratonga", 5, 100, "Priest Kelian has suggested that I free the Diseased Ratonga in the Thieves' Way from their pain.    I can reach the Thieves' Way by using the sewer entrances in and around the City of Freeport.", 611, 1)
...
function Step1Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "Speak with Priest Kelian", 1, "I should return to Kelian in the City of Freeport for continued guidance.", 11, 1)
...
function Step3Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "Speak with Priest Kelian", 1, "I should bring this flower back to Priest Kelian in the City of Freeport so that he can see what I have found.", 11, 1)
...
function Step4Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 5, "Collect gravel viper poison sacs", 5, 100, "The Priest has told me to trust in my guiding spirits to direct me to the gravel vipers that contains the most lethal poison in the Sprawl.  I can reach the Sprawl by using any of the bells in and around the City of Freeport.", 113, 1)
...
function Step5Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 6, "I should talk to Priest Kelian.", 1, "I should bring these poison sacs back to Priest Kelian in the City of Freeport.", 11, 1)
