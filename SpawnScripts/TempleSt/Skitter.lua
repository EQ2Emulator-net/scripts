...
function waypoints(NPC)
	...
	MovementLoopAddLocation(NPC, 23.7, 2.99, 57.87, Speed1, 0)
	MovementLoopAddLocation(NPC, 23.7, 2.99, 57.87, Speed2, 0)
	MovementLoopAddLocation(NPC, 23.7, 2.99, 57.87, Speed2, 10)
