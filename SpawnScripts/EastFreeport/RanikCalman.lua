...
function Dialog4(NPC, Spawn)
	...
	Dialog.AddOption("[Create a sad song that comes to mind]","Dialog4a")
	Dialog.Start()
end
...
if Race == 0 then -- Barbarian
    ...
    PlayFlavor(Spawn, "", "Halas' echoes resonate in a barbarian's croon, A song of sorrow, in Freeport's city, beneath the cold shattered moon.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "Hate's bitter symphony, in the ruins' cruel fate, A Teir'Dal weeps for a love entwined with Fallen Gate.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "In the city's noise, Erudite laments in tune, A mind unappreciated, beneath the indifferent broken moon.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "Temple Street echoes a gnome's melancholy croon, Tinkering sans love, in ratonga shadows, under the fractured moon.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "Barggar's Court weeps beneath the moon's indifferent boon, A half-elf's sorrow, in the echoes of a love lost too soon.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "Under Freeport's watchful towers, love's melody is strewn, A betrayed soul laments, beneath the moon's cold tune.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "Under Freeport's banner, a reptilian croon, Longing for the empire, 'neath the shattered Luclin moon.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "Beneath Freeport's towers, a Kerran mourns, A feline soul weeps, as their lover's essence is torn.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "With fists like thunder, still, a heart yearns true, In the battlefield's chaos, love's war cries pursue.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "Through alleys dark, where secrets intertwine, Ratonga weeps, in the city's lonely design.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "Amidst the hunt, I seek what I can't name, In the taste of sorrow, love becomes my game.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "Through Teir'Dal whispers, my heart's lament, In shadows cast, a forlorn love, forever spent.", "orate", 0, 0)
    ...
    PlayFlavor(Spawn, "", "In the depths of shadows, I fade away, Lost in echoes of love, in the cold dark's sway.", "orate", 0, 0)
    else
    ...
    PlayFlavor(Spawn, "", "Amidst the sea's lament, a whispering plea, In the abyss of parting, love sank beneath the Tranquil Sea.", "orate", 0, 0)	
end
    AddTimer(NPC,2800,"Dialog2b",1,Spawn)
end
