...
function InRange(NPC, Spawn)
	 if MakeRandomInt(1, 100) <= 18 and GetFactionAmount(Spawn,12) >0 then
	    ...
	    PlayFlavor(NPC, "voiceover/english/darkelf_eco_evil_1/ft/service/innkeeper/darkelf_innkeeper_service_evil_1_aoi_gm_523a90f5.mp3", "Ah hello there!  A traveling adventurer.  You're in luck, we just had a recent death... err last minute cancellation.", "hello", 2131223265, 1605898906, Spawn, 0)
