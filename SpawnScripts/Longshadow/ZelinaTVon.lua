...
function Dialog1b(NPC,Spawn)
	FaceTarget(NPC, Spawn)
	Dialog.New(NPC, Spawn)
	Dialog.AddDialog("Fine, you persistent pest, my love has done something I can't forgive. I've just brainstormed an idea that could use someone who doesn't mind getting their hands dirty.  If you are successful... I could scrounge up a few coins for your assistance.")
...
function Dialog1c(NPC,Spawn)
    ...
    Dialog.AddOption("Sound like a lie. What does that have to do with me?","Dialog1d")
...
function Dialog3(NPC,Spawn)
	...
	Dialog.AddDialog("I'll never understand why a lover's eyes wander. Imagine how effective removing them would be?")
