...
function RouteOne(NPC, Spawn)
	...
	MovementLoopAddLocation(NPC, X , Y, Z + 5, 2, math.random(8,15))
	MovementLoopAddLocation(NPC, X + 5, Y, Z -5, 2, math.random(8,15))
	MovementLoopAddLocation(NPC, X + 5, Y, Z + 4, 2, math.random(8,15))
...
function RouteTwo(NPC, Spawn)
	...
	MovementLoopAddLocation(NPC, X-5, Y, Z, 2, 0,  "ChooseMovement")
end
...
function RouteThree(NPC, Spawn)
	...
	MovementLoopAddLocation(NPC, X + 5, Y, Z, 2, math.random(8,15))
	MovementLoopAddLocation(NPC, X -5, Y, Z - 4, 2, math.random(8,15))
	MovementLoopAddLocation(NPC, X + 7, Y, Z +5, 2, math.random(8,15))
	MovementLoopAddLocation(NPC, X + 5, Y, Z - 5, 2, math.random(8,15))
