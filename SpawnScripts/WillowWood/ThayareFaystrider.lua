...
function Dialog1(NPC, Spawn)
	...
	Dialog.AddOption("You speak of the dark elves?  ", "Dialog15")
...
function Dialog2(NPC, Spawn)
	...
	Dialog.AddOption("Where did they come from?", "Dialog13")
	Dialog.AddOption("I shall remember your words. Farewell.")
	Dialog.Start()
end
...
function Dialog3(NPC, Spawn)
	...
	Dialog.AddOption("You fought in this war? ", "Dialog14")
	Dialog.AddOption("What is the Faydark? ")
	Dialog.AddOption("I shall remember your words. Farewell.")
	Dialog.Start()
end
...
function Dialog6(NPC, Spawn)
	...
	Dialog.AddOption("When did she die? ", "Dialog3")
	Dialog.AddOption("I shall remember your words. Farewell.")
	Dialog.Start()
end
...
function Dialog7(NPC, Spawn)
	...
	Dialog.AddOption("Then you lost the war?", "Dialog11")
	Dialog.AddOption("I shall remember your words. Farewell.")
	Dialog.Start()
end
...
function Dialog8(NPC, Spawn)
	...
	Dialog.AddOption("Why would you rejoice on your deathbed? ")
...
function Dialog9(NPC, Spawn)
	...
	Dialog.AddOption("How did you end up here?", "Dialog4")
	Dialog.AddOption("I shall remember your words. Farewell.")
	Dialog.Start()
end
...
function Dialog10(NPC, Spawn)
	...
	Dialog.AddOption("So the war was not long?", "Dialog9")
	Dialog.AddOption("I shall remember your words. Farewell.")
	Dialog.Start()
end
...
function Dialog12(NPC, Spawn)
	...
	Dialog.AddOption("What about Kelethin?", "Dialog7")
	Dialog.AddOption("I shall remember your words. Farewell.")
	Dialog.Start()
end
...
function Dialog14(NPC, Spawn)
	...
	Dialog.AddOption("How did it begin?", "Dialog2")
	Dialog.AddOption("I shall remember your words. Farewell.")
	Dialog.Start()
end
...
function Dialog15(NPC, Spawn)
	...
	Dialog.AddOption("Then do not fight anymore. ", "Dialog8")
	Dialog.AddOption("I shall remember your words. Farewell.")
	Dialog.Start()
end
...
function Dialog16(NPC, Spawn)
	...
	Dialog.AddOption("The cataclysms have passed. ", "Dialog1")
