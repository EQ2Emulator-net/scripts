...
function Decide(NPC,Spawn)
    ...
    Dialog.AddOption("Thief is such a vulgar word. I think the term rogue is more to my liking.","Rogue1")	
...
function Bard1(NPC,Spawn)
    ...
    PlayFlavor(NPC, "", "", "orate", 0, 0, Spawn)
    Dialog.AddOption("A group of wealthy merchants? I enjoy being the center of attention...","Bard2")	
    Dialog.AddOption("I'm not too sure anymore.  Do you advise I specialize somewhere else?","Decide")	
	Dialog.Start()
end
...
--	Dialog.AddVoiceover("voiceover/english/counselor_vemerik/qey_north/counselor_vemerik026.mp3", 3456483414, 216988233) UNKNOWN
    PlayFlavor(NPC, "", "", "ponder", 0, 0, Spawn)
    Dialog.AddOption("I'm too focused to be anything other than a predator.","Predator2")	
    Dialog.AddOption("I'm not too sure anymore.  Do you advise I specialize somewhere else?","Decide")	
	Dialog.Start()
end
